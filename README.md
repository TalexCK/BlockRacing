...
Plugin version: 26.3.1

Requirements: Minecraft Java Edition 26.3, Paper 26.3, and Java 25. BlockRacing uses Paper APIs directly and does not support Spigot.
...
1. Set up a Paper 26.3 server running Java 25.
