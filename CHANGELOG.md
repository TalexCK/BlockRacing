...
- 补全以往遗漏的方块：白桦木悬挂式告示牌、去皮金合欢原木、煤炭块、粗铜块（简单）；铁块、粗铁块、红石块、紫水晶块（中等）；青金石矿石、深层青金石矿石、青金石块、金块、粗金块、钻石块、绿宝石块、下界合金块及管珊瑚/气泡珊瑚/火珊瑚/鹿角珊瑚全系列（含失活）（困难）
- 染色方块库补全其余颜色的混凝土、带釉陶瓦、染色玻璃、染色玻璃板、陶瓦，以及粉红色/淡灰色羊毛、床、地毯和淡蓝色床、地毯
